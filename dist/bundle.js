...
/***/ "./src/js/createEventListeners.js":
/*!****************************************!*\
  !*** ./src/js/createEventListeners.js ***!
  \****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nfunction formatDate(date) {\n\n\tvar moment = void 0;\n\n\tif (!arguments.length) {\n\t\tmoment = new Date();\n\t} else {\n\t\tmoment = new Date(date);\n\t}\n\n\tvar day = moment.getDate().toString().length === 1 ? \"0\" + moment.getDate().toString() : moment.getDate().toString();\n\tvar month = moment.getMonth().toString().length === 1 ? \"0\" + (moment.getMonth() + 1).toString() : (moment.getMonth() + 1).toString();\n\tvar year = moment.getFullYear().toString();\n\tvar hours = moment.getHours().toString().length === 1 ? \"0\" + moment.getHours().toString() : moment.getHours().toString();\n\tvar minutes = moment.getMinutes().toString().length === 1 ? \"0\" + moment.getMinutes().toString() : moment.getMinutes().toString();\n\n\tvar momentStr = day + \"-\" + month + \"-\" + year + \" \" + hours + \":\" + minutes;\n\treturn momentStr;\n}\n\nmodule.exports = formatDate;\n\n//# sourceURL=webpack:///./src/js/formatDate.js?");
